...
function CreateMoneyPotButton() {
  ...
  return (
    <Box>
      ...
      >
        Tạo hũ tiêu dùng mới
      </Button>
      {createPortal(
        <Sheet
          className='bg-white text-black'
          visible={visible}
          title='Tạo hũ tiêu dùng'
        ...
        >
          <Box className='gap-2' flex flexDirection='column' alignItems='center' p={4}>
            <Controller
              ...
              render={({ field }) => <Input {...field} className='w-full' label='Tên hũ' placeholder='Nhập tên hũ' />}
            />
...
export default CreateMoneyPotButton;
